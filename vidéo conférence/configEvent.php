...
if (isset($_POST['modify'])) {
    $params = [
        ...
        'bookingOpen' => intval($_POST['bookingOpen']),
        'id' => intval($_POST['id']),
    ];
...
<div class="page-content">
    <div class="form">
        <h2> <?php
            ...
            ?> </h2>
        <form action="configEvent.php" name="event" method="post">
            <div class="item">
            ...
            if ($modification) {
                ...
                ?>
                <div class="item">
                    <button type="submit" name="create" class="button button-valid">Créer</button>
                </div>
                <?php
            }
            ?>
